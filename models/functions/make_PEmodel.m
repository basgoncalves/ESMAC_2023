...
% angle = % in degrees
function [ ready ] = make_PEmodel( answerModel, deformed_model, answerMarkerSet, deform_bone, which_leg, angle, angle_NS, geometryFolder, applyTibiaTorsionToJointOffset)
...
if strcmp(deform_bone, bone) == 1; % Rotation of the tibia
    ...
    placeNameModel = tibia_Rajag(dataModel, markerset, answerLegTibia, rightboneTibia, TT_angle,...
        ...
        dataToes, place, applyTibiaTorsionToJointOffset, geometryFolder);
